...
OUTER APPLY  (
      SELECT  CONVERT(char(10), CAST(CAST(S.active_start_date AS char(8)) AS datetime), 103) AS active_start_date
        , CONVERT(char(10), CAST(CAST(S.active_end_date AS char(8)) AS datetime), 103) AS active_end_date
    ) AS AD
OUTER APPLY  (
